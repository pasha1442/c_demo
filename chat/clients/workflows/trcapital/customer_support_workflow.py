...
from chat.clients.workflows.trcapital.tools import create_support_ticket, find_customer_info
...
def create_workflow():
    ...
    members = ["customer_finder", "ticket_creator", "FINISH"]
    ...
    workflow.add_conditional_edges(
        "call_tool",
        lambda x: x["sender"],
        {"customer_finder": "ticket_creator", "ticket_creator":"ticket_creator"}
    )
